...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<?php
		the_content('');
		wp_link_pages( array( 'before' => '<div class="nav-posts">' . __( 'Pages:', 'open-source-dk' ), 'after' => '</div>' ) );
	...
	<div id="nav-posts" class="navigation">
		<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'open-source-dk' ) . '</span> %title' ); ?></div>
		<div class="nav-next"><?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'open-source-dk' ) . '</span>' ); ?></div>
	</div>

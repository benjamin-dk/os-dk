...
////  OTHER NOTES
- Text domain for translation: 'open-source-dk'
...
function my_wfx_lang_setup() {
	load_theme_textdomain( 'open-source-dk', WF_THEME_URL . '/assets/languages' );
}
...
function my_wfx_register_nav(){
	register_nav_menus( array(
		'primary' => __( 'Primary navigation', 'open-source-dk' ),
		'secondary' => __( 'Secondary navigation', 'open-source-dk' ),
	) );
}
